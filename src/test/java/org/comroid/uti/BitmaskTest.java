...
public class BitmaskTest {
    ...
    public void testArrange_1() {
        ...
        Assert.assertEquals(1, Bitmask.arrange(false,false,true));
        Assert.assertEquals(2, Bitmask.arrange(false,true,false));
        Assert.assertEquals(3, Bitmask.arrange(false,true,true));
        Assert.assertEquals(4, Bitmask.arrange(true,false,false));
        Assert.assertEquals(5, Bitmask.arrange(true,false,true));
        Assert.assertEquals(6, Bitmask.arrange(true,true,false));
